...
export default async function CommandCenterPage() {
  ...
  return (
    <>
      <PageHeader title="Command Center" lead="The decisions in this window" />
          ...
          <>
            <div className="flex items-center gap-2">
              ...
              <span className="t-eyebrow">
                Your first move in this window · {scope.dataAsOf}
              </span>
            </div>
      ...
      {/* Market shape — R12, given its own slot rather than a place in
          ...
          On raw impact it would rank last of five in this window (1,600
